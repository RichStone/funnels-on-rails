...
We are using the Bullet Train framework on top of Rails. You need to find the right documentation for the right plan in Bullet Train documentation so agents can use those to execute their implementation:

- https://bullettrain.co/docs
